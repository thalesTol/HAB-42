...
local function criarBarraDePaginas(telas,numeroTotal)
	...
	varGlobal.VetorBotoesBarra.numeroSprite = display.newText("",0,0,"paolaAccent.ttf",50)
	...
	varGlobal.VetorBotoesBarra.meuSlider.x = W/2
	varGlobal.VetorBotoesBarra.meuSlider.y = 1280-150
