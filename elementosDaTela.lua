...
function M.criarAnotacoesComentarios(pagina,telas,Var,varGlobal)
	...
	local function criarCampoAnotacao()
		...
		Var.anotacao.retanguloFundo0 = display.newRoundedRect(Var.anotacao.Barra.x+10,Var.anotacao.Barra.y + 2,Var.anotacao.Barra.width*2 - 10,200,6)
		Var.anotacao.retanguloFundo0.strokeWidth = strokeWidth
		Var.anotacao.retanguloFundo0:setStrokeColor(0,0,0)
		Var.anotacao.retanguloFundo0.anchorX=0;Var.anotacao.retanguloFundo0.anchorY=0
		Var.anotacao.retanguloFundo0:setFillColor(.9,.9,.9)
		Var.anotacao.retanguloFundo0.height = Var.anotComInterface.fundoBranco.height-strokeWidth*2
		Var.anotacao:insert(1,Var.anotacao.retanguloFundo0)
		...
		Var.anotacao.scrollView = widget.newScrollView(
			{
				width = Var.anotacao.Barra.width*2 - 10-100+2,
				height = Var.anotacao.retanguloFundo0.height-200,
				scrollWidth = Var.anotacao.Barra.width*2 - 10-100,
				scrollHeight = Var.anotacao.retanguloFundo0.height,
				hideBackground = true,
				horizontalScrollDisabled  = true,
				listener = scrollListener
			}
		...
		Var.anotacao.scrollView.x = -10
		Var.anotacao.scrollView.y = Var.anotacao.Barra.y + 2+100
		
		Var.anotacao.retanguloFundo = display.newRoundedRect(0,0,Var.anotacao.Barra.width*2 - 10-100,200,12)
			...
			if Var.anotacao and Var.anotComInterface then
				...
				elseif Var.anotacao then
					...
					elseif Var.anotacao.vetorAnotacao["vazio"] == false then
						...
						if Var.anotacao.retanguloFundo.height <= Var.anotacao.retanguloFundo0.height-200 then
							Var.anotacao.scrollView:setScrollHeight( Var.anotacao.retanguloFundo0.height-200 )
						else
		...
		local posTexto =  Var.anotacao.Barra.y + Var.anotacao.Barra.height + 50
		Var.anotacao.texto = {}
		Var.anotacao.grupoAnotacao= display.newGroup()


		Var.anotacao:insert(Var.anotacao.grupoAnotacao)
		Var.anotacao.texto = display.newText(Var.anotacao.conteudo,0,0,Var.anotacao.retanguloFundo.width-10,0,native.systemFont,25)
		...
		local function janelaDeAnotacao()
			...
			local salvar = widget.newButton(
			{
				...
				onRelease = function(e)
								...
								if alturaRetangulo <= Var.anotacao.retanguloFundo0.height-200 then
									Var.anotacao.scrollView:setScrollHeight( Var.anotacao.retanguloFundo0.height-200 )
								else
		...
		Var.anotacao.editar = widget.newButton(
		{
			...
			width = Var.anotacao.retanguloFundo0.width/5,
			height = 40,
			fillColor = { default={ 0.18, 0.67, 0.785, 1 }, over={ 0.004, 0.368, 0.467, 1 } },
			strokeColor = { default={ 0, 0, 0 }, over={ 0, 0, 0,.7 } },
			strokeWidth = 0,
		...
		Var.anotacao.editar.y = Var.anotacao.retanguloFundo0.y + Var.anotacao.retanguloFundo0.height - 40
		...
		Var.anotacao.apagar.y = Var.anotacao.retanguloFundo0.y + Var.anotacao.retanguloFundo0.height - 40
	...
	local function criarCampoComentario()
		local strokeWidth = 2
		Var.comentario.retanguloFundo = display.newRoundedRect(Var.anotacao.Barra.x+10,Var.anotacao.Barra.y + 2,Var.anotacao.Barra.width*2 - 10,200,6)
		Var.comentario.retanguloFundo.strokeWidth = strokeWidth
		...
		Var.comentario.retanguloFundo.height = Var.anotComInterface.fundoBranco.height-strokeWidth*2
		...
		Var.comentario.scrollView = widget.newScrollView(
			{
				width = Var.comentario.retanguloFundo.width-30,
				height = Var.comentario.retanguloFundo.height-200,
				scrollHeight = Var.comentario.retanguloFundo.height,
				hideBackground = true,
				horizontalScrollDisabled  = true,
				listener = scrollListener
			}
		...
		Var.comentario.scrollView.y = Var.anotacao.Barra.y + 2+100
		...
		local function criarBaloesDeComentarios(vetorComentarios,diminuirParaResposta,eventResp)
			...
			for i=1,#vetorComentarios do
				...
				local posTexto =  0--Var.anotacao.Barra.y + Var.anotacao.Barra.height + 20
				--print("posTexto!!!",posTexto, Var.anotacao.Barra.y)
				if Secundario then
					posTexto =  Secundario.y + Secundario.height - 20
					local sv=Var.comentario.scrollView:getView() Var.comentario.scrollView:setScrollHeight(sv.contentHeight+ Secundario.height)
				...
				textoComentarios[i].x = 0--Var.anotacao.Barra.x + 20
				-- se existe erro então criar botão de tentar novamente --s
				if vetorComentarios.vazio or vetorComentarios.erro then
					...
					local x = 0--Var.anotacao.Barra.x +20
				...
				if not Secundario then
					sv=Var.comentario.scrollView:getView() Var.comentario.scrollView:setScrollHeight(sv.contentHeight)
				end
			end
			if Secundario then
				for i=1,#Var.comentario.vetorPrinc do
		...
		function Var.comentario.comentarioListener( event )
			...
			if Var.anotComInterface.BarraTextoTopo.x then -- verificar se cancelou antes da leitura
				...
				Var.comentario.comentar.y = Var.comentario.retanguloFundo.y + Var.comentario.retanguloFundo.height - 10
				Var.comentario.comentar.x = Var.comentario.retanguloFundo.x + 10
				...
				Var.comentario.atualizar.anchorY = 1
				Var.comentario.atualizar.y = Var.comentario.retanguloFundo.y + Var.comentario.retanguloFundo.height - 20
				Var.comentario.atualizar.x = Var.comentario.retanguloFundo.x + Var.comentario.retanguloFundo.width - 10
	...
	Var.anotComInterface.varCtrl.criarBotaoTTSAux = function()
		if (Var.anotComInterface and Var.anotComInterface.varCtrl and Var.anotComInterface.varCtrl.mensLida and Var.anotComInterface.varCtrl.anotLida) or ( not Var.comentario.Barra and Var.anotComInterface.varCtrl and Var.anotComInterface.varCtrl.anotLida) then
			print("ACHOU TTS MENSANOT!!!!")
			if not Var.comentario.Barra then
		...
		if e.target.clicado == true  then
			...
			local function FecharBarra(e)
				...
				if Var.anotComInterface.telaProtetiva then
					...
					if Var.comentario and Var.comentario.Barra then
					...
					if Var.anotComInterface.BarraTextoTopo2 then
			...
			Var.anotComInterface.fechar.x = W - 63
			Var.anotComInterface.fechar.y = 27 + Var.anotComInterface.fechar.height
			...
			Var.anotacao.Barra.y = 105 - PosY--GRUPOGERAL.height+100--Var.proximoY+ 40
			
			Var.anotacao.Barra.x = 50+ 2 - PosX
			...
			if telas.ativarLogin == "sim" then
				...
				Var.comentario.Barra.y = 105- PosY--GRUPOGERAL.height+100--Var.proximoY+ 40
			...
			Var.anotComInterface.BarraTextoTopo = display.newText(Var.anotComInterface,"anotação",0,0,"Fontes/paolaAccent.ttf",45)
			Var.anotComInterface.BarraTextoTopo:setFillColor(0,0,0)
			Var.anotComInterface.BarraTextoTopo.anchorX=0;Var.anotComInterface.BarraTextoTopo.anchorY=0
			Var.anotComInterface.BarraTextoTopo.x = Var.anotacao.Barra.x + 10 + 5 + 10
			Var.anotComInterface.BarraTextoTopo.y = Var.anotacao.Barra.y + 5
			local BarraTextoTopo2
			if telas.ativarLogin == "sim" then
				Var.anotComInterface.BarraTextoTopo2 = display.newText(Var.anotComInterface,"Fórum",0,0,"Fontes/paolaAccent.ttf",45)
				Var.anotComInterface.BarraTextoTopo2:setFillColor(0,0,0)
				Var.anotComInterface.BarraTextoTopo2.anchorX=1;Var.anotComInterface.BarraTextoTopo2.anchorY=0
				Var.anotComInterface.BarraTextoTopo2.x = Var.comentario.Barra.x + 10 + Var.comentario.Barra.width/2
				Var.anotComInterface.BarraTextoTopo2.y = Var.comentario.Barra.y + 6
			end
			...
			if telas.ativarLogin == "sim" then
				...
				Var.anotComInterface.BarraTextoTopo2.alpha = 0
			end
			Var.anotacao.Barra.tipo = "anotacao"
			Var.anotComInterface.BarraTextoTopo.alpha = 0
			...
			if telas.ativarLogin == "sim" then
				...
				Var.anotComInterface.BarraTextoTopo2.alpha = 1
			end
			Var.anotComInterface.BarraTextoTopo.alpha = 1
			
			Var.anotacao.abriu = true
			local aux = {}
			if telas.ativarLogin == "sim" and Var.comentario.BarraEsconder2.selecionada == true then
				Var.comentario.gruposComentarios.alpha = 1
				Var.comentario.retanguloFundo.alpha = 1
